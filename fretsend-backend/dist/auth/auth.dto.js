...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'admin@fretsend.com', description: 'Adresse email' }),
    (0, class_validator_1.IsEmail)({}, { message: 'Email invalide' }),
    __metadata("design:type", String)
], LoginDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Admin123!', description: 'Mot de passe (min 6 caractères)' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(6, { message: 'Mot de passe trop court (min 6 caractères)' }),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'jean@email.com' }),
    (0, class_validator_1.IsEmail)({}, { message: 'Email invalide' }),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '+33 6 00 00 00 00' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Le refresh token reçu lors du login' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
