...
exports.PricingModule = PricingModule = __decorate([
    (0, common_1.Module)({ controllers: [pricing_controller_1.PricingController], providers: [pricing_service_1.PricingService], exports: [pricing_service_1.PricingService] })
], PricingModule);
